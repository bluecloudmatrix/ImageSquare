...
SquareManager.prototype.getImagesInfo = function ( ) {
    var data = {
...
SquareManager.prototype.getResourceUsage = function(container, done)
{
    var self = this
...
SquareManager.prototype.getContainerInfo = function(container)
{
    var data = {
        port: config.cadvisors_port
        , hostname: container.server
...
SquareManager.prototype.getMachineInfo = function(container, done)
{
    var data = {
        port: config.cadvisors_port
        , hostname: container.server
...
SquareManager.prototype.getInterval = function(current, previous)
{
...
SquareManager.prototype.getOverallUsage = function(machineInfo, containerInfo)
{
...
SquareManager.prototype.getBroadbandUse = function(machineInfo, stats)
{
...
SquareManager.prototype.getMemoryUse = function(machineInfo, stats)
{
    var cur = stats.stats[1]
        , memoryUsage = 0
...
SquareManager.prototype.hasResource = function(stats, resource) {
    return stats.stats.length > 0 && stats.stats[0][resource];
}

SquareManager.prototype.getCpuUse = function(machineInfo, stats)
{
...
module.exports = new SquareManager()